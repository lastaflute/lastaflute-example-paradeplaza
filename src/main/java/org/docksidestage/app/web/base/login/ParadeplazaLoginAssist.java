 ...
 * @author jflute
 */
public class ParadeplazaLoginAssist extends TypicalLoginAssist<Integer, ParadeplazaUserBean, Member> // #change_it also UserBean
    ...
    @Resource
    private ParadeplazaConfig config;
    @Resource
    ...
    //                                                                       =============
    @Override
    protected ParadeplazaUserBean createUserBean(Member userEntity) {
        return new ParadeplazaUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeParadeplazaKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, ParadeplazaUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<ParadeplazaUserBean> getUserBeanType() {
        return ParadeplazaUserBean.class;
    }
