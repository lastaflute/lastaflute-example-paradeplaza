 ...
 * @author jflute
 */
class PagingAssist { // #app_customize
     ...
     */
    fun <ENTITY : Entity, BEAN> createPagingResult(page: PagingResultBean<ENTITY>, items: List<BEAN>): SearchPagingResult<BEAN> {
        return SearchPagingResult(page, items)
    }
